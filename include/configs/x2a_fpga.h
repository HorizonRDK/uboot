...
/*
 * Configuration for Horizon X2A FPGA
 * 
 * Copy from x2.h
 * Copyright (C) 2019 Hobot,Lit
 */


#ifndef INCLUDE_CONFIGS_X2A_FPGA_H_
#define INCLUDE_CONFIGS_X2A_FPGA_H_
...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "mmcload=mmc rescan;" \
        "ext4load mmc 0:5 ${gz_addr} ${bootfile};" \
        "ext4load mmc 0:5 ${fdt_addr} ${fdtimage}\0" \
...
#endif   // INCLUDE_CONFIGS_X2A_FPGA_H_
